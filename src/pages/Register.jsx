        ...
        <div className="flex justify-center items-center h-screen bg-base-200">
            <div className="w-full max-w-md p-8 space-y-6 bg-base-100 rounded-lg shadow-xl">
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                    ...
                    {/* Submit Button */}
                    <button type="submit" className="bg-indigo-500 px-6 py-2 font-medium text-white transition-all duration-300 shadow-[3px_3px_0px_#000] hover:translate-x-[3px] hover:translate-y-[3px] hover:shadow-none w-full">
                        Register
                    </button>
                </form>
